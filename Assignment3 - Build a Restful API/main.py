...
@app.route('/')
def index():
    return "Please navigate to /boats or /slips use this API"\
...
@app.route('/boats/<boat_id>', methods=['DELETE','GET','PATCH'])
def boats_put_delete(boat_id):
    ...
    if request.method == 'DELETE':
        ...
        if boat_key != None:
            ...
            if boat != None:
                ...
                for e in result:
                    try:
                        current_boat = e["current_boat"]

                        if int(current_boat) != None and current_boat == int(boat_id):
    ...
    # PATCH new items into the boats
...
@app.route('/slips/<slip_id>', methods=['DELETE','GET'])
...
with app.test_request_context():
    print(url_for('slips_get_delete', slip_id='5643280054222848'))
    print(url_for('slips_get_post'))
    #http://localhost:8080/slips/5643280054222848
